...
//  Sudoku
//
//  Created by Ned Beigi on 10/27/19.
...
static vector< vector<char> > getGrid(int n)
{
    if (n == 9)
    {
...
static vector< vector<char> > emptyGrid(int size)
{
    vector< vector<char> > res(size, vector<char>(size, '0'));
    return res;
}
